...
-- Last updated: Sat Mar 22 03:05:36 PM +03 2025

-- Enable UUID extension
CREATE EXTENSION IF NOT EXISTS "uuid-ossp";

CREATE TABLE activity_logs (  "id" uuid NOT NULL DEFAULT gen_random_uuid(),\n  "property_id" uuid,\n  "created_at" timestamp with time zone DEFAULT now(),\n  "unit_id" uuid,\n  "organization_id" uuid NOT NULL,\n  "description" text NOT NULL,\n  "activity_type" character varying(100) NOT NULL,\n  "metadata" jsonb,\n  "user_id" uuid\n);
CREATE TABLE announcement_schedules (  "start_date" timestamp with time zone NOT NULL,\n  "repeat_on" jsonb,\n  "time_of_day" time without time zone NOT NULL,\n  "announcement_id" uuid NOT NULL,\n  "end_date" timestamp with time zone,\n  "created_at" timestamp with time zone NOT NULL DEFAULT now(),\n  "updated_at" timestamp with time zone NOT NULL DEFAULT now(),\n  "next_run" timestamp with time zone NOT NULL,\n  "repeat_frequency" text,\n  "id" uuid NOT NULL DEFAULT gen_random_uuid()\n);
CREATE TABLE announcement_targets (  "target_type" text NOT NULL,\n  "created_at" timestamp with time zone NOT NULL DEFAULT now(),\n  "target_name" text,\n  "id" uuid NOT NULL DEFAULT gen_random_uuid(),\n  "updated_at" timestamp with time zone NOT NULL DEFAULT now(),\n  "announcement_id" uuid NOT NULL,\n  "target_id" uuid\n);
