...
export default function AddLease() {
  ...
  const handleSubmitLease = async (leaseData: any, databaseLeaseData: any) => {
    try {
      ...
      // Payment periods are now automatically generated by database triggers
      // So we don't need to call generateLeasePaymentPeriods anymore
  ...
  // Function to generate payment periods for a lease (DEPRECATED - now handled by database triggers)
  // Keeping as reference but no longer called
